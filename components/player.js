...
AudioObject.prototype.addEventListeners = function() {
  this.audio.addEventListener(
    'timeupdate',
    AudioObject.prototype.timeUpdate,
    false
  );
  this.audio.addEventListener(
    'durationchange',
    AudioObject.prototype.durationChange,
    false
  );
  this.timeline.addEventListener(
    'click',
    AudioObject.prototype.timelineClick,
    false
  );
  this.playbutton.addEventListener(
    'click',
    AudioObject.prototype.pressPlay,
    false
  );
  // Makes playhead draggable
  this.playhead.addEventListener(
    'mousedown',
    AudioObject.prototype.mouseDown,
    false
  );
...
function mouseUp(e) {
  if (onplayhead != null) {
    ...
    // change current time
    ao.audio.currentTime =
      ao.audio.duration * clickPercent(e, ao.timeline, ao.timelineWidth);
...
function createAudioPlayers() {
  for (f in files) {
    var playerString =
      ...
      f +
      '" class="play playbutton"></button><div id="timeline-' +
      f +
      '" class="timeline"><div id="playhead-' +
      f +
